    ...
    <section className="card overflow-hidden rounded-2xl">
      ...
      >
        <span className="flex items-center gap-4">
          <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary-soft text-primary [&_svg]:h-5 [&_svg]:w-5">
            {icon}
          </span>
          <span>
            <h2 className="text-[16px] font-bold text-primary">{title}</h2>
      ...
      {isOpen && (
        <div className="border-t border-theme px-5 py-6 sm:px-7">
          {children}
        </div>
      )}
    </section>
