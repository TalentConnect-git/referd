          ...
          return (
            ...
            >
              <div className="flex gap-3">
                <div className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[var(--primary-soft)]">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1.5 text-xs font-normal text-[var(--text-muted)]">
                        {specialization}
                      </p>
                    </div>
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-x-5 gap-y-2">
                    ...
                    {edu.cgpa && (
                      <div className="text-xs font-medium text-[var(--text-primary)]">
                        CGPA:{" "}
                        <span className="text-[var(--primary)]">{edu.cgpa}</span>
                      </div>
                    )}
                  </div>
                </div>
