          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* Current Role and Company - Only show if both exist */}
                {currentExperience?.role && (
                  <div className="mt-1.5 inline-flex items-center gap-1 px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-lg text-sm text-slate-300">
              ...
              <div className="flex flex-col items-end gap-2 flex-shrink-0">
                ...
                {/* Social Links Row - Below Action Buttons */}
                <div className="flex items-center gap-2">
                  {applicant?.resume && (
                    <button
                  ...
                  {applicant?.linkedin && (
                    <button
                      onClick={() =>
                        handleOpenLink(applicant.linkedin as string)
                      }
                      className="
                        inline-flex
                        items-center
