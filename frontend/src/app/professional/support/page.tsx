  ...
  return (
    <div className="min-h-screen bg-background text-primary">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#e8f5e9] via-[#f1f8e9] to-[#e3f2fd] dark:hidden" />
        ...
        <div className="absolute inset-0 hidden dark:block">
          ...
          <div className="absolute -bottom-40 -left-40 h-[500px] w-[500px] rounded-full bg-primary-soft/15 blur-3xl" />
          <div className="absolute top-1/2 left-1/2 h-[400px] w-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-info/10 blur-3xl" />
        </div>

        {/* Animated Orbs - Light Mode */}
        <div className="absolute -top-20 -right-20 h-60 w-60 rounded-full bg-green-200/60 blur-3xl animate-pulse dark:hidden" />
        <div className="absolute -bottom-20 -left-20 h-60 w-60 rounded-full bg-blue-200/60 blur-3xl animate-pulse delay-1000 dark:hidden" />
        <div className="absolute top-1/2 left-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-200/40 blur-3xl animate-pulse delay-500 dark:hidden" />

        {/* Animated Orbs - Dark Mode */}
        <div className="absolute -top-20 -right-20 h-60 w-60 rounded-full bg-primary/10 blur-3xl animate-pulse hidden dark:block" />
        <div className="absolute -bottom-20 -left-20 h-60 w-60 rounded-full bg-primary-soft/20 blur-3xl animate-pulse delay-1000 hidden dark:block" />
        <div className="absolute top-1/2 left-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-info/5 blur-3xl animate-pulse delay-500 hidden dark:block" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 text-sm text-muted">
            ...
            <span>Built with ❤️ for students, professionals, freshers and the relationships that connect them.</span>
          </div>
        </div>
      </div>
